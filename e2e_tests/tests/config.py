...
DEFAULT_TF2_CPU_IMAGE = "determinedai/environments-dev:py-3.8-pytorch-2-tf-2.11-cpu-1150a9b"
DEFAULT_TF1_GPU_IMAGE = "determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-6eceaca"
DEFAULT_TF2_GPU_IMAGE = "determinedai/environments-dev:cuda-11.3-pytorch-2-tf-2.11-gpu-1150a9b"
DEFAULT_PT_CPU_IMAGE = "determinedai/environments-dev:py-3.8-pytorch-2-cpu-1150a9b"
DEFAULT_PT_GPU_IMAGE = "determinedai/environments-dev:cuda-11.3-pytorch-2-gpu-1150a9b"
