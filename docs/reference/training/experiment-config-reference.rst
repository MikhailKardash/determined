...
-  ``determinedai/environments-dev:cuda-11.3-pytorch-2-tf-2.11-gpu-0.22.1`` for NVIDIA GPUs.
-  ``determinedai/environments-dev:py-3.8-pytorch-2-tf-2.11-cpu-0.22.1`` for CPUs.
