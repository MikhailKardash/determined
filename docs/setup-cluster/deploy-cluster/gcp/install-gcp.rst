...
.. code::
   ...
   det deploy gcp up --cluster-id CLUSTER_ID --project-id PROJECT_ID \
      ...
      --gpu-env-image determinedai/environments-dev:cuda-11.3-pytorch-2-tf-2.11-gpu-0.22.1 \
      --cpu-env-image determinedai/environments-dev:py-3.8-pytorch-2-tf-2.11-cpu-0.22.1
