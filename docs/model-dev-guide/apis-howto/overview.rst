...
-  ``determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.23.3`` (default)
-  ``determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-0.21.2``
-  ``determinedai/environments-dev:cuda-11.2-tf-2.8-gpu-0.23.3``

We also provide lightweight CPU-only counterparts:

-  ``determinedai/environments-dev:py-3.8-pytorch-1.12-tf-2.11-cpu-0.23.3``
-  ``determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-0.23.3``
-  ``determinedai/environments-dev:py-3.8-tf-2.8-cpu-0.23.3``
...
-  ``determinedai/environments-dev:rocm-5.0-pytorch-1.10-tf-2.7-rocm-0.23.3``
