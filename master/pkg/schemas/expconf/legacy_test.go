			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						...
						RawROCM: ptrs.Ptr("determinedai/environments-dev:rocm-5.0-pytorch-1.10-tf-2.7-rocm-3700b99"),
					},
		...
		// Test case with a 0.15.5 experiment config.
		{
			...
			Bytes: []byte(`
                ...
                environment:
                  ...
                  force_pull_image: false
                  image:
                    cpu: determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-3700b99
			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						RawCPU:  ptrs.Ptr("determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-3700b99"),
